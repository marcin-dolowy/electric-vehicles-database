...
private:
    ...
    bool damage;
public:
    Car(const std::string& brand, const std::string& model, const int price, const int range, const std::string& color,
    ...
    static void save_file(const std::vector<Car>& vec, const std::string& filename);
};
